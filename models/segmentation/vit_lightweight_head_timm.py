...
from models.utils.get_encoder import get_encoder
...
class VITLightweightHeadTimm(nn.Module):
    def __init__(
            self,
            img_size: int,
            model_name: str = "timm/deit3_base_patch16_384.fb_in1k",
        ...
        self.encoder = get_encoder(model_name, self.vit_in_img_size, patch_size)
